...
bool HugeInteger< T >::operator<( HugeInteger< T > &right )
{
    ...
    typename deque<T>::iterator rightIt = right.end();
    typename deque<T>::iterator rightBegin = right.begin();
...
HugeInteger< T > HugeInteger< T >::operator-( HugeInteger< T > &op2 )
{
   ...
   typename deque< T >::iterator difIt = difference.begin();
   typename deque< T >::iterator op2It = op2.begin();
   typename deque< T >::iterator difItPlus = difIt;
   typename deque< T >::iterator op2End = op2.end();
...
HugeInteger< T > HugeInteger< T >::operator*( HugeInteger< T > &op2 )
{
   ...
   typename deque< T >::iterator it4 = it3;
   for (++it4; it3 != product.end(); ++it3, ++it4)
       if (*it3 >= 10)
       {
           *it4 += *it3 / 10;
           *it3 %= 10;
...
HugeInteger< T > HugeInteger< T >::operator/( HugeInteger< T > &op2 )
{
   ...
   unsigned int remainderSize = remainder.size();
   ...
   typename deque< T >::iterator it4 = remainder.begin();
   ...
   typename deque< T >::iterator it3II = quotient.begin();
