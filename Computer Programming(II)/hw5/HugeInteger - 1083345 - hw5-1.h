...
#include "Vector - 1083345 - hw5.h" // include definition of class vector 
...
bool HugeInteger< T >::operator<( const HugeInteger< T > &right ) const
{
    ...
    typename vector< T >::iterator it1 = numI.integer.end() - 1;
    typename vector< T >::iterator it2 = numII.integer.end() - 1;
